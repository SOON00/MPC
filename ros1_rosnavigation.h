...
namespace local_planner
{
    ...
    public:
        ...
        void guidancePathCallback(const nav_msgs::Path::ConstPtr& msg);
        ...
        void combineAndProcessObstacles();
    ...
    private:
        ...
        void visualize();
        bool _follow_global_path = true;
        ros::Subscriber guidance_path_sub_;
        nav_msgs::Path _guidance_path;

        std::vector<DynamicObstacle> _dynamic_obstacles_from_costmap;
        std::vector<DynamicObstacle> _dynamic_obstacles_from_obstacle_topic;
        ros::Publisher follow_global_path_pub_;
        nav_msgs::OccupancyGrid::ConstPtr latest_global_costmap_;
